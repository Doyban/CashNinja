...
FruitNinja.Coin9Times = function (game_state, name, position, properties) {
  "use strict";
...
FruitNinja.Coin9Times.prototype = Object.create(FruitNinja.Cuttable.prototype);
FruitNinja.Coin9Times.prototype.constructor = FruitNinja.Coin9Times;

FruitNinja.Coin9Times.prototype.kill = function () {
  "use strict";
...
FruitNinja.Coin9Times.prototype.cut = function () {
  "use strict";
  FruitNinja.Cuttable.prototype.cut.call(this); // Extend cut method from Cuttable class.

  this.game_state.score += 8; // Increment score by 8.
