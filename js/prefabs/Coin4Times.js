...
FruitNinja.Coin4Times = function (game_state, name, position, properties) {
  "use strict";
...
FruitNinja.Coin4Times.prototype = Object.create(FruitNinja.Cuttable.prototype);
FruitNinja.Coin4Times.prototype.constructor = FruitNinja.Coin4Times;

FruitNinja.Coin4Times.prototype.kill = function () {
  "use strict";
...
FruitNinja.Coin4Times.prototype.cut = function () {
  "use strict";
  FruitNinja.Cuttable.prototype.cut.call(this); // Extend cut method from Cuttable class.

  this.game_state.score += 3; // Increment score by 3.
