...
CashNinja.Coin10Times = function (game_state, name, position, properties) {
  "use strict";
...
CashNinja.Coin10Times.prototype = Object.create(CashNinja.Cuttable.prototype);
CashNinja.Coin10Times.prototype.constructor = CashNinja.Coin10Times;

CashNinja.Coin10Times.prototype.kill = function () {
  "use strict";
...
CashNinja.Coin10Times.prototype.cut = function () {
  "use strict";
  CashNinja.Cuttable.prototype.cut.call(this); // Extend cut method from Cuttable class.

  this.basic_score = 10; // Set up basic score for this coin.
