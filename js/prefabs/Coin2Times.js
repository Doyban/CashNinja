...
CashNinja.Coin2Times = function (game_state, name, position, properties) {
  "use strict";
...
CashNinja.Coin2Times.prototype = Object.create(CashNinja.Cuttable.prototype);
CashNinja.Coin2Times.prototype.constructor = CashNinja.Coin2Times;

CashNinja.Coin2Times.prototype.kill = function () {
  "use strict";
...
CashNinja.Coin2Times.prototype.cut = function () {
  "use strict";
  CashNinja.Cuttable.prototype.cut.call(this); // Extend cut method from Cuttable class.

  this.basic_score = 2; // Set up basic score for this coin.
