...
CashNinja.Coin9Times = function (game_state, name, position, properties) {
  "use strict";
...
CashNinja.Coin9Times.prototype = Object.create(CashNinja.Cuttable.prototype);
CashNinja.Coin9Times.prototype.constructor = CashNinja.Coin9Times;

CashNinja.Coin9Times.prototype.kill = function () {
  "use strict";
...
CashNinja.Coin9Times.prototype.cut = function () {
  "use strict";
  CashNinja.Cuttable.prototype.cut.call(this); // Extend cut method from Cuttable class.

  this.basic_score = 9; // Set up basic score for this coin.
