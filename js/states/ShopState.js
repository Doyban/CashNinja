...
CashNinja.ShopState.prototype = Object.create(CashNinja.JSONLevelState.prototype);
CashNinja.ShopState.prototype.constructor = CashNinja.ShopState;

CashNinja.ShopState.prototype.create = function () {
  "use strict";
  ...
  menu = new CashNinja.MenuShop(this, "menu", menu_position, menu_properties); // Create menu.
};