...
FruitNinja.Coin10Times = function (game_state, name, position, properties) {
  "use strict";
...
FruitNinja.Coin10Times.prototype = Object.create(FruitNinja.Cuttable.prototype);
FruitNinja.Coin10Times.prototype.constructor = FruitNinja.Coin10Times;

FruitNinja.Coin10Times.prototype.kill = function () {
  "use strict";
...
FruitNinja.Coin10Times.prototype.cut = function () {
  "use strict";
  FruitNinja.Cuttable.prototype.cut.call(this); // Extend cut method from Cuttable class.

  this.game_state.score += 9; // Increment score by 9.
